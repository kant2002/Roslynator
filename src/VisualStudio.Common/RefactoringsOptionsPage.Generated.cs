...
namespace Roslynator.VisualStudio
{
    public partial class RefactoringsOptionsPage
    {
        ...
        protected override void Fill(ICollection<BaseModel> refactorings)
        {
            ...
            refactorings.Add(new BaseModel(RefactoringIdentifiers.ConvertInterfaceToAbstractClass, "Convert interface to abstract class", IsEnabled(RefactoringIdentifiers.ConvertInterfaceToAbstractClass)));
