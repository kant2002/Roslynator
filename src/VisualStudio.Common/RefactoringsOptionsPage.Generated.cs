...
namespace Roslynator.VisualStudio
{
    public partial class RefactoringsOptionsPage
    {
        ...
        protected override void Fill(ICollection<BaseModel> refactorings)
        {
            ...
            refactorings.Add(new BaseModel(RefactoringIdentifiers.SimplifyConditionalExpression, "Simplify conditional expression", IsEnabled(RefactoringIdentifiers.SimplifyConditionalExpression)));
        }
    }
}